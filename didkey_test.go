...
func Test_NewDIDKeyFromDID(t *testing.T) {
	...
	for _, tc := range testCases {
		tests = append(tests, struct {
			...
			want:    &didkey.DIDKey{PublicKey: *tc.PublicKey, PrivateKey: nil},
			wantErr: false,
		})
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := didkey.NewDIDKeyFromDID(tt.args.did)
...
func Test_NewDIDKeyFromPrivateKey(t *testing.T) {
	...
	for _, tc := range testCases {
		tests = append(tests, struct {
			...
			want:    &didkey.DIDKey{PublicKey: *tc.PublicKey, PrivateKey: tc.PrivateKey},
			wantErr: false,
		})
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := didkey.NewDIDKeyFromPrivateKey(tt.args.privateKey)
			if (err != nil) != tt.wantErr {
